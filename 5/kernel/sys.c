...
{
	/*
	 * This is my syscall function
	 * get timeval and timespec while return jiffies
	 */
	jiffies_to_timespec(jiffies,x_time);
	jiffies_to_timeval(jiffies,t_time);

	return jiffies;
}

/*return pfcount and store current time in tv with do_gettimeofday */
...
{
	printk("This is my system calling");
	return num +10;
}
